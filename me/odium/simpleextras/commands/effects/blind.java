...
public class blind implements CommandExecutor {   
  ...
  public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args)  {    
    ...
    if (args.length == 0) {
      ...
      sender.sendMessage(ChatColor.GOLD + "* " + ChatColor.WHITE + "You have been blinded for " + ChatColor.GREEN + "1" + ChatColor.WHITE + " minute");
      return true;
      ...
      if (target == null) {
        ...
        target.sendMessage(ChatColor.GOLD + "* " + ChatColor.WHITE + "You have been blinded for " + ChatColor.GREEN + "1" + ChatColor.WHITE + " minute");
        return true;
      }
      ...
      target.sendMessage(ChatColor.GOLD + "* " + ChatColor.WHITE + "You have been blinded for " + ChatColor.GREEN + min + ChatColor.WHITE + " minutes");
      return true;
    } 
